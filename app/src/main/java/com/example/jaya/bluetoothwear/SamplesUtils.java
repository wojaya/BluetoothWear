...
/**
 * Created by jaya on 2017/5/27.
 */

public abstract class SamplesUtils {
    public static void indeterminate (Context context, Handler handler, String message, final Runnable runnable, DialogInterface.OnDismissListener dismissListener)
    {
        try
        {
